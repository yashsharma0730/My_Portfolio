...
const skills = {
  "Programming Languages": [
    { name: "Python", icon: "PY", color: "#00599C", textColor: "#fff" },
    { name: "JAVA", icon: "JAVA", color: "#004482", textColor: "#fff" },
  ...
  "Relevant Courses": [
    { name: "Data Structures & Algorithms", icon: "🧩", color: "#1abc9c", textColor: "#fff" },
    { name: "CN", icon: "🛜", color: "#16a085", textColor: "#fff" },
  ...
  "Machine Learning & AI": [
    { name: "Scikit-Learn", icon: "SCI",color: "#cb3837" , textColor: "#fff" },
    { name: "Keras", icon: "Keras", color: "#38b2ac", textColor: "#000" },
    { name: "Tensorflow", icon: "TF", color: "#000", textColor: "#fff" },
    { name: "Hugging Face", icon: "HF",color: "#444", textColor: "#fff" },
    { name: "OpenCV", icon: "OC",  color: "#800000", textColor: "#fff" },
    { name: "Pandas", icon: "🐼", color: "#563d7c", textColor: "#fff" },
    { name: "Numpy", icon: "🔢", color: "#61dafb", textColor: "#fff" },
    { name: "MatplotLib", icon: "📊", color: "#3c873a", textColor: "#fff" },
    { name: "GenAI", icon: "GenAI",color: "#cb3837" , textColor: "#fff" },
    { name: "LLM", icon: "LLM",color: "#444" , textColor: "#fff" },
  ],
  "Frameworks": [
